...
knitr::opts_chunk$set(echo = F, cache=F, cache.comments = F, message = F, warning = F, 
                      tidy.opts=list(width.cutoff=60), tidy=TRUE  8
                      )  
...
# --> ask Roy's replacement to rever back to not using imp_quality, exact_coverage, and imputed_coverage separtely for MM and ST?
