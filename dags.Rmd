...
full_dag <-dagify(Dementia~TRAP+BMI+CVHealth+Smoking+APOE+Sex+Year+SES, #+PhysAct+Surv65
...
ggsave(file.path(image_path, "Other", "dag_relationship.png"), width = 10, height = 6)
