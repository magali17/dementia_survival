...
* these analyses use the new data predictions but only for the old Study IDs and years to incrase comparability 
* The current TRAP survival analyses use a coverage threshold of 0.5, so the new dataset has slightly fewer person-years than the original, which didn't have a threshold by <3% of the person-years had a threshold < 98%.
